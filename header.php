                ...
                <?php if (function_exists('pll_the_languages')) :
                    ...
                    <div class="relative inline-block text-left">
                        ...
                        <button id="langDropdownButton" data-dropdown-toggle="langDropdown"
                                class="cursor-pointer text-white bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center w-36"
                                type="button">
