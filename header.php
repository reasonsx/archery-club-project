                ...
                if (function_exists('pll_the_languages')) :
                    ...
                    <div class="relative inline-block text-left">
                        ...
                        <button id="langDropdownButton" data-dropdown-toggle="langDropdown"
                                class="cursor-pointer text-gray-900 focus:outline-none border bg-white border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center w-36"
                                type="button">
