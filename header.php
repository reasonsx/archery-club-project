            ...
            if (function_exists('pll_the_languages')) :
                ...
                <div class="relative inline-block text-left">
                    ...
                    <button id="langDropdownButton" data-dropdown-toggle="langDropdown"
                            class="cursor-pointer text-gray-900 focus:outline-none bg-white hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-300 rounded-lg px-4 py-2.5 text-center inline-flex items-center w-auto"
                            type="button">
