...
<section class="flex flex-col gap-24">
    ...
    <section class="h-96 w-full bg-cover bg-center flex items-center justify-center" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/frontpage/home-hero.jpg');">
