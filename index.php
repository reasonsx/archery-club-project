                ...
                <div class="max-w-screen-lg mx-auto w-full">
                    <div class="max-w-2xl space-y-6 text-white">
                        ...
                        <a href="<?php echo esc_url(get_permalink(get_page_by_path('how-to-join'))); ?>"
                           class="cursor-pointer focus:outline-none text-black bg-[#FDD576] focus:ring-4 focus:ring-[#fdd576]/50 font-medium rounded-lg text-base px-6 py-2 inline-block transition text-center">
                            Join Now
                        </a>
                    </div>
                </div>
