...
?>
<section class="h-[30vh] md:h-[50vh] bg-no-repeat bg-center bg-cover relative flex items-center justify-center text-white"
  ...
  <!-- Text on top -->
  <h1 class="text-black text-center max-sm:text-5xl sm:text-8xl md:text-[120px] font-bold z-10"><?php echo nl2br(esc_html($title)); ?></h1>
