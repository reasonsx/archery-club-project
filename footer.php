...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl text-center">
        ...
        <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
            <li>
                <a class="mr-4 hover:underline md:mr-6" href="<?php echo get_permalink(get_page_by_path('about-us')); ?>">About us</a>
            </li>
            <li>
                <a class="mr-4 hover:underline md:mr-6" href="<?php echo get_permalink(get_option('page_for_posts')); ?>">Blog</a>
            </li>
            <li>
                <a class="mr-4 hover:underline md:mr-6" href="<?php echo get_permalink(get_page_by_path('how-to-join')); ?>">How to join</a>
            </li>
            <li>
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 1954-2025 <a href="#" class="hover:underline">Sønderborg Bueskyttelaug</a>. All Rights Reserved.</span>
    </div>
</footer>
