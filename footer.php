<footer class="px-4 pt-4 bg-white sm:px-6 sm:pt-2 shadow-inner shadow-gray-200 mt-12">
    <div class="mx-auto max-w-screen-xl">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 md:grid-cols-4">
                <div>
                    ...
                    <ul class="text-gray-600">
                        <li class="mb-4">
                            <span>Monday:</span><br><span>18:00 – 19:30</span>
                        </li>
                        <li class="mb-4">
                            <span>Thursday:</span><br><span>18:00 – 19:30</span>
                        </li>
                    </ul>
                </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="https://www.facebook.com/profile.php?id=100057323084944#" target="_blank"
                   class="text-gray-500 hover:text-gray-900 flex flex-row gap-1">
